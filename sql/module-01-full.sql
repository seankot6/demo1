-- Модуль 1: ЧитайГород — создание таблиц + заполнение
-- Запускать на ПУСТОЙ базе C:\BookStore\database.fdb
-- RDBExpert: ПКМ по подключению → Редактор запросов → вставить весь файл → F5
